...
type TeamLiabilitiesResolver interface {
	DeadCap(ctx context.Context, obj *team.TeamLiabilities) ([]*team.DeadCapYear, error)
}
...
func (ec *executionContext) _TeamLiabilities_deadCap(ctx context.Context, field graphql.CollectedField, obj *team.TeamLiabilities) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.TeamLiabilities().DeadCap(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	for i, field := range fields {
		...
		case "deadCap":
			...
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				...
				res = ec._TeamLiabilities_deadCap(ctx, field, obj)
				return res
			}
